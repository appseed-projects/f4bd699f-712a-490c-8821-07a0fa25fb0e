...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-11 18:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f4bd699f-712a-490c-8821-07a0fa25fb0e.git
$ cd f4bd699f-712a-490c-8821-07a0fa25fb0e
```
